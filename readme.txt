...
Version 0.21 corrects an error in the plugin URI. If you used the "plugin homepage" link to download version 
...
TextImage probably isn't for you. If you want to maintain a weblog for a private community and keep a low profile, TextImage 
might help.

If you just need an occasional TextImage and don't want to install the plugin, just go to http://t2img.com/ where you can 
use the free web service to create your image.
...
TextImage needs an image cache directory where WordPress can write the image files. If you create this in wp-content an give 
it the same permissions it should work. 
...
TextImage expects to find .ttf font files in /usr/share/fonts. It will recursively search directories under there to find 
font files.
